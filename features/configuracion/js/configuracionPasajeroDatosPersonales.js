...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // Límites de la fecha de nacimiento (15 a 90 años)
...
btnRegresar.addEventListener("click", function () {
  ...
  setModoEdicion(true);
  console.log("🔓 Modo edición activado para datos personales del pasajero");
});
...
btnGuardarCambios.addEventListener("click", function () {
  ...
  if (btnGuardarCambios.disabled) {
    // Si por algún motivo lo clican estando desactivado
  ...
  // Volvemos a modo solo lectura y recargamos los datos guardados
